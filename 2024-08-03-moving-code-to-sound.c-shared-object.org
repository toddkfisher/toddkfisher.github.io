#+title:  Continuing with sound-related coding
...
Miniaudio's [fn:miniaudio] low-level API.  All of this code lived in ~simple-playback.c~ which was
...
*END*
[fn:miniaudio] See https://miniaud.io/
----------
